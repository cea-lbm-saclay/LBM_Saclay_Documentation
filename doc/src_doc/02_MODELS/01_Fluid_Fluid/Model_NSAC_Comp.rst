...
.. tab-set::
   ...
   .. tab-item:: Force and source terms
   ...
   .. tab-item:: Closure relationships

      .. admonition:: Closure relationships
         :class: caution
   ...
   .. tab-item:: Alternative phase-field model

      .. admonition:: Alternative phase-field model
         :class: caution
