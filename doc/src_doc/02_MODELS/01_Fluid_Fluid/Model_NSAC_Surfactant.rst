...
.. tab-set::
   ...
   .. tab-item:: Force and source terms
      ...
      .. admonition:: Force and source terms
         :class: caution
         ...
         .. grid:: 2
            ...
            .. grid-item-card:: Marangoni force
               ...
               where :math:`W` is the interface width and :math:`\textcolor{red}{\sigma(c)}` is the surface tension varying with composition :math:`c`. Two phenomenological laws are given on the next tab-item.
   
   
      .. admonition:: Source term of Eq. :eq:`CAC_Equation_Surf`
         :class: caution
   ...
   .. tab-item:: Phenomenological laws for :math:`\sigma`
