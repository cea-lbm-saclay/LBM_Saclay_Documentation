...
.. admonition:: Run and post-process your results
   ...
   - Once the computation is complete, extract from your final ``.vti`` file one profile :math:`u_y` as a function of :math:`x` with paraview 5.12
   ...
   - Compare with the analytical solution written in the python script ``Profils_NSCH-BGK_Analytical.py``
    ...
    You must obtain Fig :numref:`Fig-Tuto5_DoublePoiseuille`

   .. figure:: ../FIGS/01_FIGS_VALIDATIONS/Fig_Tuto5_DoublePoiseuille.png
       :name: Fig-Tuto5_DoublePoiseuille
       :height: 350
       :width: 500
       :scale: 95
       :align: center
   
       Comparison between LBM and analytical solution of double-Poiseuille flow
